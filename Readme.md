...
## <u>Fonctionnement du script :</u>

Ce script Bash interactif permet de gérer différentes fonctionnalités du système via un menu structuré. Il propose trois grandes catégories :

        1) Gestion des périphériques (processus, utilisation du disque, monitoring avec btop et htop).
        2) Gestion des utilisateurs (ajout, suppression et affichage d’un utilisateur).
        3) Gestion du réseau (ajout/suppression d’adresse IP, test de connectivité, résolution DNS).
